...
<div class="row">
	...
	<div id="section">
		<form action="afterreg.php" method="POST">
		...
		<br>
		<input type="text" class="form-control" name="national_id" placeholder="Enter NID" required> 
		<br>
		...
		<br>
		<input name= "submit" type="submit" value="Sign Up"  style="color:black">
		</fieldset> 			 
		</form>
	</div>
	</div>
