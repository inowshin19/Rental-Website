...
//$apt=$_SESSION['apt_id'];
$apt=$_GET['id'];
$sql=mysql_query("SELECT * FROM image WHERE apartment_id='$apt'");
...
$sql1 = "SELECT apartment.size, apartment.floor_no, apartment.property_type, apartment.property_price, apartment.num_of_bedroom, apartment.num_of_bathroom FROM apartment where apartment_id = '".$apt."'";
$sql2 = "SELECT feature.service_charge, feature.garage, feature.lift, feature.description, feature.availability  FROM feature where apartment_id = '".$apt."'";
$sql3 = "SELECT address.holding_number, address.property_name, address.area, address.road_number, address.post_office, address.zip_code FROM address where apartment_id = '".$apt."'";
$sql4 = "SELECT review.rating, review.comment FROM review where apartment_id = '".$apt."'";
...
<li><a class="w3-dark-grey w3-padding-hor-16" href="signin.php">Adds</a></li>  
  ...
  <li><a class="w3-padding-hor-16" href="about us.php">About Us</a></li>
  <a class="glyphicon glyphicon-log-in" class="w3-padding-hor-16"style="position:absolute; top:4%; left:92%; color:white;" href="frontpage.php"> LogOut</a></li>
  <br>
  <a class="glyphicon glyphicon-log-in" class="w3-padding-hor-16"style="position:absolute; top:8%; left:92%; color:white;" href="edit apartment info.php"> Edit Add</a></li>
  </ul>
...
<div class="container">
  <div class="col-sm-8">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="photos/<?php echo '$pic1' ?>" height="100" width="200" text="IMAGE" alt="Image">
        ...
        <div class="item">
          <img src="photos/<?php echo '$pic2' ?>" height="100" width="200" text="Another Image Maybe" alt="Image">
          <div class="carousel-caption">
            <h3>Home Heaven</h3>
    ...
    <div class="item active">
          <img src="photos/<?php echo '$pic3' ?>" height="100" width="200" text="IMAGE" alt="Image">
          <div class="carousel-caption">
            <h3>Home Heaven</h3>
          </div>     
        </div>
